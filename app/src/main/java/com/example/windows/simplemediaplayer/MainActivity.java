package com.example.windows.simplemediaplayer;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String mPath="/storage/emulated/0/Music/exodus.mp3";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (uri !=null) if (intent.getType().contains("audio")) {
            setContentView(android.R.layout.simple_list_item_1);
            mMediaPlayer = MediaPlayer.create(this,R.raw.exodus);
            try{
                mMediaPlayer.start();
            } catch (Exception e) {
                e.printStackTrace();
